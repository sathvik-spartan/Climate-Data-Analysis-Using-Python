...
```bash
git clone https://github.com/sathvik-spartan/Climate-Data-Analysis-Using-Python.git
```

### Navigate to the Project Directory

```bash
cd Climate-Data-Analysis-Using-Python
```
...
Open the notebook file and execute the cells sequentially to reproduce the analysis and visualizations.
